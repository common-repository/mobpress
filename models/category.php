...
class WPSDK_Category {
  ...
  function WPSDK_Category($wp_category = null) {
    if ($wp_category) {
  ...
  function import_wp_object($wp_category) {
    ...
    $this->title = html_entity_decode($wp_category->name);
    $this->description = html_entity_decode($wp_category->description);
